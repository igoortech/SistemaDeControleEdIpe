...
app.controller('myCtrl', ['$scope','$filter','$http','$sce', function ($scope, $filter,$http,$sce){
    ...
    $scope.funcionarios = []
    $scope.prestadores = []
    $scope.destinos = [120,101,102,103,104,201,202,203,204,301,302,303,304,401,402,403,404,501,502,503,504,601,602,603,604,701,702,703,704,801,802,803,804,901,902,903,904,1001,1002,1003]
    $scope.selectedReg = {}
